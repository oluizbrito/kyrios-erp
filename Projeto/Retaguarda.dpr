...
uses
  ...
  uFichaClienteReceber
    in '..\View\uFichaClienteReceber.pas' {frmCadFichaClieR} ,
  ...
  uSuprimento_Sangria
    in '..\View\uSuprimento_Sangria.pas' {FrmSuprimento_Sangria} ,
  ...
  uHistorico_Usuario
    in '..\View\uHistorico_Usuario.pas' {frmHistorico_usuario} ,
  ...
  uCadDevolucaoComrpa
    in '..\View\uCadDevolucaoComrpa.pas' {frmCadDevolucaoCompra} ,
  ...
  uParFinanceiroCartao
    in '..\View\uParFinanceiroCartao.pas' {frmParFinanceiroCartao} ,
  uHistoricoVendaProduto_Vdd
    in '..\View\uHistoricoVendaProduto_Vdd.pas' {frmHistoricoVendaProduto_VDD} ,
  ...
  ufrmDefaultCadastro
    in '..\Boleto\ufrmDefaultCadastro.pas' {frmDefaultCadastro} ,
  ufrmDefaultClean in '..\Boleto\ufrmDefaultClean.pas' {frmDefaultClean} ,
  ufrmDefaultConsulta
    in '..\Boleto\ufrmDefaultConsulta.pas' {frmDefaultConsulta} ,
  ufrmMENSAGEMespera in '..\Boleto\ufrmMENSAGEMespera.pas' {frmMENSAGEMespera} ,
  ufrmREMESSAcadastro
    in '..\Boleto\ufrmREMESSAcadastro.pas' {frmREMESSAcadastro} ,
  ufrmREMESSAmanutencao
    in '..\Boleto\ufrmREMESSAmanutencao.pas' {frmREMESSAmanutencao} ,
  ufrmREMESSArelatorio
    in '..\Boleto\ufrmREMESSArelatorio.pas' {frmREMESSArelatorio} ,
  ufrmRETORNOmanutencao
    in '..\Boleto\ufrmRETORNOmanutencao.pas' {frmRETORNOmanutencao} ,
  ufrmRETORNOrelatorio
    in '..\Boleto\ufrmRETORNOrelatorio.pas' {frmRETORNOrelatorio} ,
  uRespTecnico in '..\View\uRespTecnico.pas' {frmRespTecnico} ,
  uTerminais in '..\View\uTerminais.pas' {frmTerminais} ,
  uHistoricoVendaProduto
    in '..\View\uHistoricoVendaProduto.pas' {frmHistoricoVendaProduto} ,
  uHistoricoVendaProduto_Cliente
    in '..\View\uHistoricoVendaProduto_Cliente.pas' {frmHistoricoVendaProduto_Cliente} ,
  uParInventarioImposto
    in '..\View\uParInventarioImposto.pas' {frmParCSOSNCST} ,
  uEstoque_FI_Insuficiente
    in '..\View\uEstoque_FI_Insuficiente.pas' {frmEstoque_FI_Insuficiente} ,
  ...
  unit_esmaecer_fundo
    in '..\View\unit_esmaecer_fundo.pas' {form_esmaecer_fundo} ,
  ...
  uGeradorPixMercadoPago
    in '..\View\update43\uGeradorPixMercadoPago.pas' {frmGeradorPixMercadoPago} ,
  uGeradorMultiPix
    in '..\View\update43\uGeradorMultiPix.pas' {frmGeradorMultiPix} ,
  uGerarPixNormalQrCode
    in '..\View\update43\uGerarPixNormalQrCode.pas' {frmGerarPixNormalQrCode} ,
  uAguardarGeracaoPix
    in '..\View\update43\uAguardarGeracaoPix.pas' {frmAguardarGeracaoPix} ,
  ...
  uGradeEntrada in '..\View\update43\uGradeEntrada.pas' {FrmGradeEntrada} ,
  uPrincipio_Ativo in '..\View\uPrincipio_Ativo.pas' {frmPrincipio} ,
  uDMForte in '..\View\update43\uDMForte.pas' {dmForte: TDataModule} ,
  uListaImport in '..\View\update43\uListaImport.pas' {frmListaImport} ,
  uListaPedidoImpNFe
    in '..\View\update43\uListaPedidoImpNFe.pas' {frmListaPedidoImpNFe} ,
  uConsCliForNFe in '..\View\update43\uConsCliForNFe.pas' {frmConsCliForNFe} ,
  uAPITelegramMensagem in '..\View\uAPITelegramMensagem.pas',
  uEnvioWhatsApp in '..\View\update43\uEnvioWhatsApp.pas' {frmEnvioWhatsApp} ,
...
begin
  ...
  Application.Title := 'Sistema ERP Fiscal';
  ...
  Application.CreateForm(TfrmTrocaPDV, frmTrocaPDV);
