object frmCadCompra: TfrmCadCompra
  ...
  object qryCompra: TFDQuery
    ...
    object qryCompraBASE_FCP: TBCDField
      FieldName = 'BASE_FCP'
      Origin = 'BASE_FCP'
      Precision = 18
    end
  ...
  object qryItensCompra: TFDQuery
    ...
    object qryItensCompraTOTAL: TFMTBCDField
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      Precision = 18
      Size = 6
    end
    object qryItensCompraPR_ANTERIOR: TBCDField
      FieldName = 'PR_ANTERIOR'
      Origin = 'PR_ANTERIOR'
      Precision = 18
    end
    object qryItensCompraPR_MARGEM: TBCDField
      FieldName = 'PR_MARGEM'
      Origin = 'PR_MARGEM'
      Precision = 18
    end
    object qryItensCompraPR_SUGESTAO: TBCDField
      FieldName = 'PR_SUGESTAO'
      Origin = 'PR_SUGESTAO'
      Precision = 18
    end
    object qryItensCompraPR_VENDA_ANTERIOR: TBCDField
      FieldName = 'PR_VENDA_ANTERIOR'
    ...
    object qryItensCompraQTD_RESTANTE: TFMTBCDField
      FieldName = 'QTD_RESTANTE'
      Origin = 'QTD_RESTANTE'
      Precision = 18
      Size = 6
    end
    object qryItensCompraVFCP: TBCDField
      FieldName = 'VFCP'
      Origin = 'VFCP'
      Precision = 18
    end
    object qryItensCompraVL_OPERACAO: TFMTBCDField
