...
type
  TfrmConfig = class(TForm)
    ...
    cxSair: TcxButton;
    cxGravar: TcxButton;
    TestarConexaoAppButton: TButton;
    TestarConexaoLicencaButton: TButton;
    ...
    procedure TestarConexaoLicencaButtonClick(Sender: TObject);
    procedure cxGravarClick(Sender: TObject);
    procedure cxSairClick(Sender: TObject);
    procedure TestarConexaoAppButtonClick(Sender: TObject);
  private
    ncopias: string;
...
procedure TfrmConfig.TestarConexaoAppButtonClick(Sender: TObject);
begin
  ConfigurarConexaoWebApp;
end;

procedure TfrmConfig.TestarConexaoLicencaButtonClick(Sender: TObject);
begin
...
procedure TfrmConfig.ConfigurarConexaoWebApp;
begin
  dadosweb.MysqlAPP.VendorLib := ExtractFilePath(application.ExeName) + 'libmysql.dll';
...
procedure TfrmConfig.ConfigurarConexaoWebLicenca;
begin
