...
type
  TFrmXml = class(TForm)
    ...
    qryXmlMasterBASE_FCP: TBCDField;
    qryXMLDetailQUANT_E: TBCDField;
    qryXMLDetailQUANT_S: TBCDField;
    qryXMLDetailQTD_TOTAL: TBCDField;
    qryXMLDetailEMBALAGEM: TBCDField;
    ...
    qryXMLDetailPR_ANTERIOR: TBCDField;
    qryXMLDetailPR_MARGEM: TBCDField;
    qryXMLDetailPR_SUGESTAO: TBCDField;
    qryXMLDetailPR_VENDA_ANTERIOR: TBCDField;
    qryXMLDetailPRECO_CUSTO: TBCDField;
    ...
    qryXMLDetailPRECO_C_DESCONTO: TBCDField;
    qryXMLDetailCSOSN: TStringField;
    qryXMLDetailVFCP: TBCDField;
    ...
    qryCadProdutoGLP: TBCDField;
    qryCadProdutoGNN: TBCDField;
    qryCadProdutoGNI: TBCDField;
    qryCadProdutoPESO_LIQ: TBCDField;
    qryCadProdutoANP: TStringField;
    qryCadProdutoCOMBUSTIVEL: TStringField;
    qryCadProdutoFK_LCP: TStringField;
    qryCadProdutoISSQN: TBCDField;
    qryCadProdutoTIPO_TRIBUTACAO: TStringField;
    qryCadProdutoID_PRODUTO_SIMILAR: TIntegerField;
    qryCadProdutoTRIBUTACAO_MONOFASICA: TStringField;
    qryCadProdutoID_MENU: TIntegerField;
    qryCadProdutoVALOR_PEQUENA: TBCDField;
    qryCadProdutoVALOR_MEDIA: TBCDField;
    qryCadProdutoVALOR_GRANDE: TBCDField;
    qryCadProdutoTIPO_ALIMENTO: TStringField;
    qryCadProdutoSERIAL: TStringField;
    qryCadProdutoMVA_NORMAL: TBCDField;
    qryCadProdutoIMPRIME_TICKET: TStringField;
    qryCadProdutoICMS_DIFERIDO: TBCDField;
    qryCadProdutoQTD_SABORES: TIntegerField;
    qryCadProdutoCOD_ENQ_IPI: TStringField;
    qryCadProdutoALIQ_DESON: TBCDField;
    qryCadProdutoMOTIVO_DESONERACAO: TIntegerField;
    qryCadProdutoCOD_BENEFICIO: TStringField;
    qryCadProdutoFABRICADO: TStringField;
    qryCadProdutoPESO_L: TBCDField;
    qryCadProdutoPESO_B: TBCDField;
    qryCadProdutoCHATBOOT: TStringField;
    qryCadProdutoSITUACAO_TRIBUTARIA: TStringField;
    qryCadProdutoCODIGO_AUX: TIntegerField;
    qryCadProdutoUSA_IMEI: TStringField;
    qryCadProdutoCONTROLA_ESTOQUE_GRADE: TStringField;
    qryCadProdutoUSA_TAB_PRECO: TStringField;
    qryXMLDuplicataVALOR: TBCDField;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            qryXMLDetailQTD_TOTAL.value := qryXMLDetailEMBALAGEM.AsFloat *
