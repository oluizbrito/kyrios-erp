...
type
  TfrmCadNFe = class(TForm)
    ...
    qryProdCODIGO_AUX: TIntegerField;
    qryProdUSA_IMEI: TStringField;
    qryProdCONTROLA_ESTOQUE_GRADE: TStringField;
    qryProdUSA_TAB_PRECO: TStringField;
    ...
    qryProdutoPESO_L: TBCDField;
    qryProdutoPESO_B: TBCDField;
    ...
    qryItemPICMSDEFERIDO: TBCDField;
    qryItemVICMSDEFERIDO: TBCDField;
    qryItemVALOR_ICMS_ST_RET: TBCDField;
    qryItemVL_OPERACAO: TFMTBCDField;
    qryItemVBCSTRET: TBCDField;
    qryItemVICMSSTRET: TBCDField;
    qryItemVBCSTDEST: TBCDField;
    qryItemVICMSSTDEST: TBCDField;
    qryItemPESO_L: TBCDField;
    qryItemPESO_B: TBCDField;
    qryItemTPESO_L: TFMTBCDField;
    qryItemTPESO_B: TFMTBCDField;
...
PageControl2.ActivePageIndex := 0;
  ...
  cxPreview.Enabled := cxTransmitir.Enabled;
...
procedure TfrmCadNFe.cxBoletoClick(Sender: TObject);
var
  Femail: string;
begin
...
procedure TfrmCadNFe.cxGerarClick(Sender: TObject);
var
  i: Integer;
  vDif, vSoma: Real;
begin
...
begin
  ...
  cxGerar.Enabled := qryVendaSITUACAO.Value = '1';
  ...
  Panel1.Enabled := qryVendaSITUACAO.Value = '1';
