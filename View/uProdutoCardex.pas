...
type
  TFrmCardex = class(TForm)
    ...
    qryProdEGLP: TBCDField;
    qryProdEGNN: TBCDField;
    qryProdEGNI: TBCDField;
    qryProdEPESO_LIQ: TBCDField;
    qryProdEANP: TStringField;
    qryProdECOMBUSTIVEL: TStringField;
    qryProdEFK_LCP: TStringField;
    qryProdEISSQN: TBCDField;
    qryProdETIPO_TRIBUTACAO: TStringField;
    qryProdEQTD_FISCAL: TBCDField;
