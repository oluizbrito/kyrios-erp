object FrmXml: TFrmXml
  ...
  object qryCadProduto: TFDQuery
    ...
    object qryCadProdutoGLP: TBCDField
      FieldName = 'GLP'
      Origin = 'GLP'
      Precision = 18
    end
    object qryCadProdutoGNN: TBCDField
      FieldName = 'GNN'
      Origin = 'GNN'
      Precision = 18
    end
    object qryCadProdutoGNI: TBCDField
      FieldName = 'GNI'
      Origin = 'GNI'
      Precision = 18
    end
    object qryCadProdutoPESO_LIQ: TBCDField
      FieldName = 'PESO_LIQ'
      Origin = 'PESO_LIQ'
      Precision = 18
    end
    object qryCadProdutoANP: TStringField
      FieldName = 'ANP'
      Origin = 'ANP'
    end
    object qryCadProdutoCOMBUSTIVEL: TStringField
      FieldName = 'COMBUSTIVEL'
      Origin = 'COMBUSTIVEL'
      Size = 1
    end
    object qryCadProdutoFK_LCP: TStringField
      FieldName = 'FK_LCP'
      Origin = 'FK_LCP'
      Size = 10
    end
    object qryCadProdutoISSQN: TBCDField
      FieldName = 'ISSQN'
      Origin = 'ISSQN'
      Precision = 18
    end
    object qryCadProdutoTIPO_TRIBUTACAO: TStringField
      FieldName = 'TIPO_TRIBUTACAO'
      Origin = 'TIPO_TRIBUTACAO'
      Size = 10
    end
    object qryCadProdutoID_PRODUTO_SIMILAR: TIntegerField
      FieldName = 'ID_PRODUTO_SIMILAR'
      Origin = 'ID_PRODUTO_SIMILAR'
    end
    object qryCadProdutoTRIBUTACAO_MONOFASICA: TStringField
      FieldName = 'TRIBUTACAO_MONOFASICA'
      Origin = 'TRIBUTACAO_MONOFASICA'
      Size = 1
    end
    object qryCadProdutoID_MENU: TIntegerField
      FieldName = 'ID_MENU'
      Origin = 'ID_MENU'
    end
    object qryCadProdutoVALOR_PEQUENA: TBCDField
      FieldName = 'VALOR_PEQUENA'
      Origin = 'VALOR_PEQUENA'
      Precision = 18
    end
    object qryCadProdutoVALOR_MEDIA: TBCDField
      FieldName = 'VALOR_MEDIA'
      Origin = 'VALOR_MEDIA'
      Precision = 18
    end
    object qryCadProdutoVALOR_GRANDE: TBCDField
      FieldName = 'VALOR_GRANDE'
      Origin = 'VALOR_GRANDE'
      Precision = 18
    end
    object qryCadProdutoTIPO_ALIMENTO: TStringField
      FieldName = 'TIPO_ALIMENTO'
      Origin = 'TIPO_ALIMENTO'
      Size = 1
    end
    object qryCadProdutoSERIAL: TStringField
      FieldName = 'SERIAL'
      Origin = 'SERIAL'
      Size = 1
    end
    object qryCadProdutoMVA_NORMAL: TBCDField
      FieldName = 'MVA_NORMAL'
      Origin = 'MVA_NORMAL'
      Precision = 18
    end
    object qryCadProdutoIMPRIME_TICKET: TStringField
      FieldName = 'IMPRIME_TICKET'
      Origin = 'IMPRIME_TICKET'
      Size = 1
    end
    object qryCadProdutoICMS_DIFERIDO: TBCDField
      FieldName = 'ICMS_DIFERIDO'
      Origin = 'ICMS_DIFERIDO'
      Precision = 18
    end
    object qryCadProdutoQTD_SABORES: TIntegerField
      FieldName = 'QTD_SABORES'
      Origin = 'QTD_SABORES'
    end
    object qryCadProdutoCOD_ENQ_IPI: TStringField
      FieldName = 'COD_ENQ_IPI'
      Origin = 'COD_ENQ_IPI'
      Size = 10
    end
    object qryCadProdutoALIQ_DESON: TBCDField
      FieldName = 'ALIQ_DESON'
      Origin = 'ALIQ_DESON'
      Precision = 18
    end
    object qryCadProdutoMOTIVO_DESONERACAO: TIntegerField
      FieldName = 'MOTIVO_DESONERACAO'
      Origin = 'MOTIVO_DESONERACAO'
    end
    object qryCadProdutoCOD_BENEFICIO: TStringField
      FieldName = 'COD_BENEFICIO'
      Origin = 'COD_BENEFICIO'
    end
    object qryCadProdutoFABRICADO: TStringField
      FieldName = 'FABRICADO'
      Origin = 'FABRICADO'
      Size = 1
    end
    object qryCadProdutoPESO_L: TBCDField
      FieldName = 'PESO_L'
      Origin = 'PESO_L'
      Precision = 18
    end
    object qryCadProdutoPESO_B: TBCDField
      FieldName = 'PESO_B'
      Origin = 'PESO_B'
      Precision = 18
    end
    object qryCadProdutoCHATBOOT: TStringField
      FieldName = 'CHATBOOT'
      Origin = 'CHATBOOT'
      Size = 1
    end
    object qryCadProdutoSITUACAO_TRIBUTARIA: TStringField
      FieldName = 'SITUACAO_TRIBUTARIA'
      Origin = 'SITUACAO_TRIBUTARIA'
      Size = 1
    end
    object qryCadProdutoCODIGO_AUX: TIntegerField
      FieldName = 'CODIGO_AUX'
      Origin = 'CODIGO_AUX'
    end
    object qryCadProdutoUSA_IMEI: TStringField
      FieldName = 'USA_IMEI'
      Origin = 'USA_IMEI'
      Size = 1
    end
    object qryCadProdutoCONTROLA_ESTOQUE_GRADE: TStringField
      FieldName = 'CONTROLA_ESTOQUE_GRADE'
      Origin = 'CONTROLA_ESTOQUE_GRADE'
      Size = 1
    end
    object qryCadProdutoUSA_TAB_PRECO: TStringField
  ...
  object qryXMLDetail: TFDQuery
    ...
    object qryXMLDetailQUANT_E: TBCDField
      FieldName = 'QUANT_E'
      Origin = 'QUANT_E'
      Precision = 18
    end
    object qryXMLDetailQUANT_S: TBCDField
      FieldName = 'QUANT_S'
      Origin = 'QUANT_S'
      Precision = 18
    end
    object qryXMLDetailQTD_TOTAL: TBCDField
      FieldName = 'QTD_TOTAL'
      Origin = 'QTD_TOTAL'
      Precision = 18
    end
    object qryXMLDetailEMBALAGEM: TBCDField
      FieldName = 'EMBALAGEM'
      Origin = 'EMBALAGEM'
      Precision = 18
    end
    ...
    object qryXMLDetailPR_ANTERIOR: TBCDField
      FieldName = 'PR_ANTERIOR'
      Origin = 'PR_ANTERIOR'
      Precision = 18
    end
    object qryXMLDetailPR_MARGEM: TBCDField
      FieldName = 'PR_MARGEM'
      Origin = 'PR_MARGEM'
      Precision = 18
    end
    object qryXMLDetailPR_SUGESTAO: TBCDField
      FieldName = 'PR_SUGESTAO'
      Origin = 'PR_SUGESTAO'
      Precision = 18
    end
    object qryXMLDetailPR_VENDA_ANTERIOR: TBCDField
      FieldName = 'PR_VENDA_ANTERIOR'
      Origin = 'PR_VENDA_ANTERIOR'
      Precision = 18
    end
    object qryXMLDetailPRECO_CUSTO: TBCDField
      FieldName = 'PRECO_CUSTO'
      Origin = 'PRECO_CUSTO'
      Precision = 18
    end
    ...
    object qryXMLDetailPRECO_C_DESCONTO: TBCDField
    ...
    object qryXMLDetailVFCP: TBCDField
      FieldName = 'VFCP'
      Origin = 'VFCP'
      Precision = 18
    end
  ...
  object qryXmlMaster: TFDQuery
    ...
    object qryXmlMasterBASE_FCP: TBCDField
      FieldName = 'BASE_FCP'
      Origin = 'BASE_FCP'
      Precision = 18
    end
  ...
  object qryXMLDuplicata: TFDQuery
    ...
    object qryXMLDuplicataVALOR: TBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      Precision = 18
    end
