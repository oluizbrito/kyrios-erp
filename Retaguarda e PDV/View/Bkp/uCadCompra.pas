...
type
  TfrmCadCompra = class(TForm)
    ...
    qryItensCompraTOTAL: TFMTBCDField;
    qryItensCompraPR_ANTERIOR: TBCDField;
    qryItensCompraPR_MARGEM: TBCDField;
    qryItensCompraPR_SUGESTAO: TBCDField;
    qryItensCompraPR_VENDA_ANTERIOR: TBCDField;
    ...
    qryItensCompraQTD_RESTANTE: TFMTBCDField;
    qryItensCompraVFCP: TBCDField;
    qryItensCompraVL_OPERACAO: TFMTBCDField;
