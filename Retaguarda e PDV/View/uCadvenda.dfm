object frmCadvenda: TfrmCadvenda
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet2: TTabSheet
        ...
        object DBGridBuscaP: TDBGridEh
          ...
          FooterParams.Font.Name = 'Trebuchet MS'
          ...
          OnDrawColumnCell = DBGridBuscaPDrawColumnCell
  ...
  object pnlprod: TPanel
    ...
    object GrpBxDadosProduto: TGroupBox
      ...
      object GroupBox2: TGroupBox
        ...
        Height = 48
        Align = alRight
        Caption = 'Quantidade e Pre'#231'o'
        TabOrder = 1
  ...
  object qryClientes: TFDQuery
    ...
    SQL.Strings = (
        ...
        ' uf, cep, fone1, celular1 , COMPLEMENTO FROM pessoa'
      'where'
      '((razao like :razao) or '
      '(cnpj like :cnpj))  and'
      '(cli='#39'S'#39')'
  ...
  object qryVenda: TFDQuery
    ...
    object qryVendaTELA: TStringField
      FieldName = 'TELA'
      Origin = 'TELA'
    end
    object qryVendaEX: TIntegerField
      FieldName = 'EX'
      Origin = 'EX'
    end
    object qryVendaALTERADO: TStringField
      FieldName = 'ALTERADO'
      Origin = 'ALTERADO'
      Size = 1
    end
    object qryVendaHORA: TTimeField
      FieldName = 'HORA'
      Origin = 'HORA'
    end
    ...
    object qryVendaVIRTUAL_UF: TStringField
      FieldKind = fkLookup
  ...
  object qryItem: TFDQuery
    ...
    object qryItemID_SERIAL: TIntegerField
      FieldName = 'ID_SERIAL'
      Origin = 'ID_SERIAL'
    end
    object qryItemFK_MESA: TIntegerField
      FieldName = 'FK_MESA'
      Origin = 'FK_MESA'
    end
    object qryItemQTD_RESTANTE: TFMTBCDField
    ...
    object qryItemVALOR_ITEM_SD: TFMTBCDField
      FieldName = 'VALOR_ITEM_SD'
      Origin = 'VALOR_ITEM_SD'
      Precision = 18
      Size = 2
    end
    object qryItemFATOR: TFMTBCDField
      FieldName = 'FATOR'
      Origin = 'FATOR'
      Precision = 18
      Size = 2
    end
    object qryItemFK_IMEI: TIntegerField
      FieldName = 'FK_IMEI'
      Origin = 'FK_IMEI'
    end
    object qryItemPR_VENDA: TFMTBCDField
      FieldName = 'PR_VENDA'
      Origin = 'PR_VENDA'
      Precision = 18
      Size = 2
    end
    object qryItemPR_CUSTO: TFMTBCDField
      FieldName = 'PR_CUSTO'
      Origin = 'PR_CUSTO'
      Precision = 18
      Size = 2
  ...
  object qryPesqProd: TFDQuery
    ...
    object qryPesqProdQTD_FISCAL: TBCDField
      FieldName = 'QTD_FISCAL'
      Origin = 'QTD_FISCAL'
      Precision = 18
    end
