...
uses
  ...
  JvEnterTab, dxSkinsCore, dxSkinDevExpressDarkStyle, dxSkinOffice2019Colorful,
...
procedure TfrmCadTransp.cxSairClick(Sender: TObject);
begin
...
procedure TfrmCadTransp.cxGravarClick(Sender: TObject);
begin
  if dados.qryTransp.State in [dsInsert, dsEdit] then
  begin
