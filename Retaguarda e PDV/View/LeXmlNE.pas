...
uses
  ...
  pcnConversao, pcnConversaoNFe, StrUtils,
...
begin
  ...
  begin
    FrmCadProduto.qryProdutosPR_CUSTO2.Value := ((dados.QryXmlDetailFRETE.AsCurrency + dados.QryXmlDetailSEGURO.AsCurrency + dados.QryXmlDetailDESPESAS.AsCurrency + dados.QryXmlDetailVL_IPI.AsCurrency
      + dados.QryXmlDetailVL_ST.AsCurrency) - dados.QryXmlDetailDESCONTO.AsCurrency) + dados.QryXmlDetailPRECO_S.AsCurrency;
    ...
    if FrmCadProduto.qryProdutosPR_CUSTO.AsFloat > 0 then
      FrmCadProduto.qryProdutosPERC_CUSTO.AsFloat := SimpleRoundTo(((FrmCadProduto.qryProdutosPR_CUSTO2.AsFloat * 100) / FrmCadProduto.qryProdutosPR_CUSTO.AsFloat) - 100, -2);
    ...
    if FrmCadProduto.qryProdutosPR_CUSTO.Value > 0 then
      FrmCadProduto.qryProdutosMARGEM.AsFloat := ((FrmCadProduto.qryProdutosPR_VENDA.AsFloat * 100) / FrmCadProduto.qryProdutosPR_CUSTO2.AsFloat) - 100;
  ...
  FrmCadProduto.qryProdutosPR_VENDA.Value := FrmCadProduto.qryProdutosPR_VENDA.Value;

  FrmCadProduto.qryProdutosMARGEM.Value := ((FrmCadProduto.qryProdutosPR_VENDA.AsFloat / FrmCadProduto.qryProdutosPR_CUSTO.AsFloat) - 1) * 100;

  FrmCadProduto.qryProdutosDESCRICAO.Value := dados.QryXmlDetailDESCRICAO_LOCAL.Value;
  ...
  FrmCadProduto.qryProdutosULTFORN.Value := dados.qryXmlMasterID_FORNECEDOR.Value;
  ...
  begin
    ...
    FrmCadProduto.qryProdutosCFOP_EXTERNO.AsString := dados.qryEmpresaCFOP_EXTERNO.AsString;
    FrmCadProduto.qryProdutosCST_EXTERNO.Value := dados.qryEmpresaCST_EXTERNO.Value;
    FrmCadProduto.qryProdutosCSOSN_EXTERNO.Value := dados.qryEmpresaCSOSN_EXTERNO.Value;
