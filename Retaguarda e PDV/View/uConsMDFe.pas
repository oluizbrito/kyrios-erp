...
begin
  ...
  try
    ...
    frmCadMDFe.cxGravar.Enabled := true;
    frmCadMDFe.cxTransmitir.Enabled := true;
    frmCadMDFe.cxSair.Enabled := true;
...
procedure TfrmConsMDFe.SpeedButton1Click(Sender: TObject);
begin
    close;
end;
