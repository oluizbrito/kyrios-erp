object FrmCardex: TFrmCardex
  ...
  object qryProdE: TFDQuery
    ...
    object qryProdEGLP: TBCDField
      FieldName = 'GLP'
      Origin = 'GLP'
      Precision = 18
    end
    object qryProdEGNN: TBCDField
      FieldName = 'GNN'
      Origin = 'GNN'
      Precision = 18
    end
    object qryProdEGNI: TBCDField
      FieldName = 'GNI'
      Origin = 'GNI'
      Precision = 18
    end
    object qryProdEPESO_LIQ: TBCDField
      FieldName = 'PESO_LIQ'
      Origin = 'PESO_LIQ'
      Precision = 18
    end
    ...
    object qryProdEISSQN: TBCDField
      FieldName = 'ISSQN'
      Origin = 'ISSQN'
      Precision = 18
    end
    ...
    object qryProdEQTD_FISCAL: TBCDField
    ...
    object qryProdEVALOR_PEQUENA: TBCDField
      FieldName = 'VALOR_PEQUENA'
      Origin = 'VALOR_PEQUENA'
      Precision = 18
    end
    object qryProdEVALOR_MEDIA: TBCDField
      FieldName = 'VALOR_MEDIA'
      Origin = 'VALOR_MEDIA'
      Precision = 18
    end
    object qryProdEVALOR_GRANDE: TBCDField
    ...
    object qryProdEMVA_NORMAL: TBCDField
    ...
    object qryProdEICMS_DIFERIDO: TBCDField
    ...
    object qryProdEALIQ_DESON: TBCDField
    ...
    object qryProdEPESO_L: TBCDField
      FieldName = 'PESO_L'
      Origin = 'PESO_L'
      Precision = 18
    end
    object qryProdEPESO_B: TBCDField
      FieldName = 'PESO_B'
      Origin = 'PESO_B'
      Precision = 18
    end
    ...
    object qryProdECODIGO_AUX: TIntegerField
      FieldName = 'CODIGO_AUX'
      Origin = 'CODIGO_AUX'
    end
    object qryProdEUSA_IMEI: TStringField
      FieldName = 'USA_IMEI'
      Origin = 'USA_IMEI'
      Size = 1
    end
    object qryProdECONTROLA_ESTOQUE_GRADE: TStringField
