...
uses
  ...
  dxSkinXmas2008Blue, ACBrTEFD, ACBrBAL, ACBrMail;
type
...
uses strutils, math, TypInfo, DateUtils, synacode,
...
begin
  ...
  begin
    ...
    MysqlChave.VendorLib := ExtractFilePath(application.ExeName) +
     ...
     if (edtDataBase_APP.Text <> '') or ( edtUsuario_APP.Text <> '') or (edtSenha_APP.Text <> '') then
      Begin
     //conexao froça de vendas
     ...
     if (edtDataBase_Li.Text <> '') or ( edtUsuario_LI.Text <> '') or (edtSenha_LI.Text <> '') then
      Begin
      //conexao licença
...
begin
  ...
  begin
    ...
    Dados.qryParametroVERSAO.Value := 500;
  end
  else
    Dados.qryParametro.Edit;
