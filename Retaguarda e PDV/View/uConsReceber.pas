...
procedure TfrmConsReceber.cxSairClick(Sender: TObject);
begin
   close;
end;
...
begin
  ...
  if dados.vLancamentoCaixa then
  begin
    cxNovo.Visible := false;
    cxAlterar.Visible := false;
    cxImp.Visible := false;
  end
  else
  begin
    cxNovo.Visible := true;
    cxAlterar.Visible := true;
    cxImp.Visible := true;
  end;
  tamanho;
  edtLoc.SetFocus;
