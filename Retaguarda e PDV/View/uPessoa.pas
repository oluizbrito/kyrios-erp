  ...
  begin
    ...
    abort;
      ...
      if Key = VK_DELETE then
        begin
          // Exibir mensagem de confirmação personalizada
          ...
          try
            ...
            begin
              ...
              // Verificação se o cliente é o "Consumidor Final"
              ...
              begin
                  ...
                  'o cliente "Consumidor Final" não pode ser excluído!',
                  mtWarning, [mbOK], 0, -1, -1);
                abort;
              end;

              // Verificação na tabela VENDAS_MASTER
              with qryTemp do
              begin
                Close;
                SQL.Clear;
                ...
                begin
                  MessageDlgPos('Esse cliente possui movimentações e não pode ser excluído!',
                                mtWarning, [mbOK], 0, -1, -1);
                  abort;
                end;
              end;
