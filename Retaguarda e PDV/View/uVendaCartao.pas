...
procedure TfrmCartaoParcela.cxAvancarClick(Sender: TObject);
var
...
procedure TfrmCartaoParcela.cxExcluirClick(Sender: TObject);
begin
...
procedure TfrmCartaoParcela.cxGerarClick(Sender: TObject);
var
  i: integer;
...
procedure TfrmCartaoParcela.cxVoltarClick(Sender: TObject);
begin
  PodeFechar := true;
