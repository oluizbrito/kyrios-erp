...
uses
  ...
  dxSkinsCore, dxSkinOffice2019Colorful, dxSkinOffice2019DarkGray;
  ...
  try
    ...
    try
      ...
      on E: EDatabaseError do
        ShowMessage('Não foi possível conectar ao servidor de licenças.' + #13#10 + 'Verifique sua conexão com a internet e tente novamente.');

      on E: EAccessViolation do
        ShowMessage('Erro interno ao acessar os dados. Reinicie o sistema e tente novamente.');

      on E: Exception do
        ShowMessage('Ocorreu um erro inesperado: ' + E.Message + sLineBreak + 'Tente novamente ou entre em contato com o suporte.');
    end;
