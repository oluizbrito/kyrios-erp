...
begin
  Dados.aMenu := 'MnDevolucaodeCompra';
    ...
    if frmDevolucaoCompra = NIL then
      ...
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmDevolucaoCompra.Caption;
end;
...
begin
  Dados.aMenu := 'MnDevolucaodeVenda';
    ...
    if frmdevolucao = NIL then
      ...
      frmdevolucao.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmdevolucao.Caption;
end;
...
begin
  Dados.aMenu := 'MnContasReceber';
    ...
    if frmConsReceber = NIL then
      ...
      frmConsReceber.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsReceber.Caption;
end;
...
begin
  ...
  if frmCompra = NIL then
      ...
      frmCompra.BorderStyle := bsNone;
      frmCompra.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmCompra.Caption;
end;
...
begin
  Dados.aMenu := 'MnLivroCaixa';
    ...
    if frmCaixa = NIL then
      ...
      frmCaixa.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmCaixa.Caption;
end;
...
begin
  ...
  if frmConsCTe_Rodo = NIL then
      ...
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsCTe_Rodo.Caption;
...
begin
  Dados.aMenu := 'MnCTEOS';
    ...
    if frmConsCTe = NIL then
      ...
      frmConsCTe.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsCTe.Caption;
end;
...
begin
  Dados.aMenu := 'MnFichadeCliente';
    ...
    if frmFichaCliente = NIL then
      ...
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmFichaCliente.Caption;
end;
...
begin
  ...
  if frmTransportadora = NIL then
      ...
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmTransportadora.Caption;
...
begin
  ...
  dxStatusBar1.Panels[5].Text := 'Versão: ' + Dados.GetBuildInfo
    (Application.ExeName);
  ...
  dxStatusBar1.Panels[2].Text := 'Usuário: ' + Dados.vUsuario;
...
begin
  Dados.aMenu := 'MnContasPagar';
    ...
    if frmConsPagar = NIL then
      ...
      frmConsPagar.BorderStyle := bsNone;
      frmConsPagar.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsPagar.Caption;
end;
...
begin
  Dados.aMenu := 'MnEmpresa';
    ...
    if frmConsEmpresa = NIL then
      ...
      frmConsEmpresa.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsEmpresa.Caption;
end;
...
begin
  Dados.aMenu := 'MnPessoas';
    ...
    if frmPessoas = NIL then
      ...
      frmPessoas.BorderStyle := bsNone;
      frmPessoas.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmPessoas.Caption;
end;
...
begin
  Dados.aMenu := 'MnMDFe';
     ...
     if frmConsMDFe = NIL then
      ...
      frmConsMDFe.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsMDFe.Caption;
end;
...
begin
  ...
  begin
    ...
    if frmSAT = NIL then
      ...
      frmSAT.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmSAT.Caption;
  end
  Else
  begin
    ...
    if frmNFCe = NIL then
      ...
      frmNFCe.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmNFCe.Caption;
...
begin
  Dados.aMenu := 'MnNFe';
    ...
    if frmConsNFe = NIL then
      ...
      frmConsNFe.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsNFe.Caption;
end;
...
begin
 Dados.aMenu := 'MnOrcamento';
  ...
  if frmOrcamento = NIL then
      ...
      frmOrcamento.BorderStyle := bsNone;
      frmOrcamento.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmOrcamento.Caption;
end;
...
begin
  Dados.aMenu := 'MnBoletoRemessa';
    ...
    if frmREMESSAmanutencao = NIL then
      ...
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmREMESSAmanutencao.Caption;
...
begin
  Dados.aMenu := 'MnBoletoRetorno';
    ...
    if frmRETORNOmanutencao = NIL then
      ...
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmRETORNOmanutencao.Caption;
...
begin
  ...
  begin
    ...
    if frmConsOS_Roupa = NIL then
      ...
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsOS_Roupa.Caption;
  end
  else
  begin
    ...
    if frmConsOS = NIL then
      ...
      frmConsOS.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmConsOS.Caption;
  end;
end;
...
begin
  ...
  if frmProdutos = NIL then
      ...
      frmProdutos.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmProdutos.Caption;
end;
...
begin
    ...
    if frmrecibo = NIL then
      ...
      frmrecibo.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmrecibo.Caption;
end;
...
begin
  Dados.aMenu := 'MnListadeVendas';
    ...
    if frmPedidoVenda = NIL then
      ...
      frmPedidoVenda.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmPedidoVenda.Caption;
end;
...
begin
  Dados.aMenu := 'MnNotasFornecedorLerXML';
    ...
    if frmManifesto = NIL then
      ...
      frmManifesto.Show;
      dxStatusBar1.Panels[0].Text := 'Você está na tela de ' + frmManifesto.Caption;
end;
