...
uses
  ...
  ACBrDFe, ACBrNFe, JvBaseEdits, dxSkinsCore, dxSkinDevExpressDarkStyle,
...
procedure TfrmCBRconfig.btnCancelarClick(Sender: TObject);
begin
  inherited;
   //wagner
end;

procedure TfrmCBRconfig.btnConfirmarClick(Sender: TObject);
begin
  inherited;
   //wagner
end;

procedure TfrmCBRconfig.cxGravarClick(Sender: TObject);
begin

 //wagner
end;

procedure TfrmCBRconfig.cxSairClick(Sender: TObject);
begin
